      ...
      <div className="md:-mt-15 max-w-7xl mx-auto px-6 py-20">
        ...
        >
         ...
         <div className="text-center ">
                <p className="text-center font-medium text-purple-100 text-2xl px-10 py-1.5 rounded-full 
bg-[linear-gradient(120deg,#6D28D9,#A855F7)] border border-purple-800 w-max mx-auto
">Why Choose us?</p>
                <h2 className="text-0.5xl font-semibold text-center mx-auto mt-4 text-black">Unlock Your Potential with Our Comprehensive Learning Approach</h2>
            </div>
            <div className="flex  flex-wrap items-center justify-center d:h-10 gap-6 md:gap-4 mt-10 px-6">
